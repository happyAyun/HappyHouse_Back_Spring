...
public class OauthToken {
	...
	public OauthToken(final String access_token, final String token_type, final String refresh_token,
			final int expires_in, final String scope, final int refresh_token_expires_in) {
